...
@section('content')
    <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
        <div class="card">
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <img src="{{ asset('/images/users/avatar-1.jpg') }}" alt="image" class="h-8 w-8 rounded">
                    <img src="{{ asset('/images/users/avatar-2.jpg') }}" alt="image" class="h-12 w-12 rounded">
                    <img src="{{ asset('/images/users/avatar-3.jpg') }}" alt="image" class="h-16 w-16 rounded">
                    <img src="{{ asset('/images/users/avatar-7.jpg') }}" alt="image" class="h-20 w-20 rounded">
                    <img src="{{ asset('/images/users/avatar-4.jpg') }}" alt="image" class="h-24 w-24 rounded">
                    <img src="{{ asset('/images/users/avatar-5.jpg') }}" alt="image" class="h-28 w-28 rounded">
                    <img src="{{ asset('/images/users/avatar-6.jpg') }}" alt="image" class="h-32 w-32 rounded">
                </div>
        ...
        <div class="card">
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <img src="{{ asset('/images/users/avatar-1.jpg') }}" alt="image" class="h-8 w-8 rounded-full">
                    <img src="{{ asset('/images/users/avatar-2.jpg') }}" alt="image" class="h-12 w-12 rounded-full">
                    <img src="{{ asset('/images/users/avatar-3.jpg') }}" alt="image" class="h-16 w-16 rounded-full">
                    <img src="{{ asset('/images/users/avatar-7.jpg') }}" alt="image" class="h-20 w-20 rounded-full">
                    <img src="{{ asset('/images/users/avatar-4.jpg') }}" alt="image" class="h-24 w-24 rounded-full">
                    <img src="{{ asset('/images/users/avatar-5.jpg') }}" alt="image" class="h-28 w-28 rounded-full">
                    <img src="{{ asset('/images/users/avatar-6.jpg') }}" alt="image" class="h-32 w-32 rounded-full">
                </div>
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <div class="relative h-8 w-8 inline-flex">
                        <img src="{{ asset('/images/users/avatar-1.jpg') }}" alt="image" class="rounded-full">
                        <div class="absolute end-0 h-2 w-2 rounded-full border border-white bg-success"></div>
                    </div>
                    <div class="relative h-12 w-12 inline-flex">
                        <img src="{{ asset('/images/users/avatar-2.jpg') }}" alt="image" class="rounded-full">
                    ...
                    <div class="h-16 w-16 relative inline-flex">
                        <img src="{{ asset('/images/users/avatar-3.jpg') }}" alt="image" class="rounded-full">
                    ...
                    <div class="h-20 w-20 relative inline-flex">
                        <img src="{{ asset('/images/users/avatar-4.jpg') }}" alt="image" class="rounded-full">
                    ...
                    <div class="h-24 w-24 relative inline-flex">
                        <img src="{{ asset('/images/users/avatar-5.jpg') }}" alt="image" class="rounded-full">
                    ...
                    <div class="h-28 w-28 relative inline-flex">
                        <img src="{{ asset('/images/users/avatar-6.jpg') }}" alt="image" class="rounded-full">
                    ...
                    <div class="relative h-32 w-32 inline-flex">
                        <img src="{{ asset('/images/users/avatar-7.jpg') }}" alt="image" class="rounded-full">
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <div class="relative inline-block">
                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <span class="absolute bottom-0 end-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-gray-400"></span>
                    </div>
                    <div class="relative inline-block">
                        <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <span class="absolute bottom-0 end-0 block h-2.5 w-2.5 rounded-full ring-2 ring-white bg-red-400"></span>
                    </div>
                    <div class="relative inline-block">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <span class="absolute bottom-0 end-0 block h-3 w-3 rounded-full ring-2 ring-white bg-green-400"></span>
                    </div>
                    <div class="relative inline-block">
                        <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
        ...
        <div class="card">
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <div class="relative inline-block">
                        <img class="inline-block h-8 w-8 rounded-md ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                    ...
                    <div class="relative inline-block">
                        <img class="inline-block h-9 w-9 rounded-md ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                    ...
                    <div class="relative inline-block">
                        <img class="inline-block h-12 w-12 rounded-md ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                    ...
                    <div class="relative inline-block">
                        <img class="inline-block h-16 w-16 rounded-md ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                ...
                <div class="flex flex-wrap items-end gap-3">
                    <div class="flex-shrink-0 group block">
                        <div class="flex items-center">
                            <img class="inline-block flex-shrink-0 h-16 w-16 rounded-full" src="{{ asset('/images/users/avatar-5.jpg') }}" alt="Image Description">
                            <div class="ms-3">
								...
								<code>
									&lt;div class=&quot;flex items-center&quot;&gt;
										&lt;img class=&quot;inline-block flex-shrink-0 h-16 w-16 rounded-full&quot;
											src=&quot;{{ asset('/images/users/avatar-5.jpg') }}&quot; alt=&quot;Image Description&quot;&gt;
										&lt;div class=&quot;ms-3&quot;&gt;
											&lt;h3 class=&quot;font-semibold text-gray-800 dark:text-white&quot;&gt;Scote Wanner&lt;/h3&gt;
											&lt;p class=&quot;text-sm font-medium text-gray-400&quot;&gt;scote@gmail.com&lt;/p&gt;
										&lt;/div&gt;
            ...
            <div class="p-6">
                <div class="flex gap-3">
                    <div class="flex -space-x-2">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        ...
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-white dark:border-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
        ...
        <div class="card">
            ...
            <div class="p-6">
                <div class="flex-col space-y-2">
                    <div class="flex">
                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex">
                        <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex">
                        <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                </div>
                    ...
                    <pre class="language-html h-56">
								<code>
									...
									&lt;img class=&quot;inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800&quot;
										src=&quot;{{ asset('/images/users/avatar-1.jpg') }}&quot; alt=&quot;Image Description&quot;&gt;
									&lt;img class=&quot;inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800&quot;
										src=&quot;{{ asset('/images/users/avatar-2.jpg') }}&quot; alt=&quot;Image Description&quot;&gt;
									&lt;img class=&quot;inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800&quot;
										src=&quot;{{ asset('/images/users/avatar-3.jpg') }}&quot; alt=&quot;Image Description&quot;&gt;
									&lt;img class=&quot;inline-block h-8 w-8 rounded-full ring-2 ring-white dark:ring-gray-800&quot;
										src=&quot;{{ asset('/images/users/avatar-4.jpg') }}&quot; alt=&quot;Image Description&quot;&gt;
								&lt;/div&gt;
								&lt;div class=&quot;flex&quot;&gt;
            ...
            <div class="p-6">
                <div class="flex flex-col gap-3">
                    <div class="flex gap-2">
                        <img class="inline-block h-8 w-8 rounded-full border-2 border-primary" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full border-2 border-primary" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full border-2 border-primary" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-8 w-8 rounded-full border-2 border-primary" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex gap-2">
                        <img class="inline-block h-9 w-9 rounded-full border-2 border-red-300" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full border-2 border-red-300" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full border-2 border-red-300" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-9 w-9 rounded-full border-2 border-red-300" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex gap-2">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-teal-500" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-teal-500" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-teal-500" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full border-2 border-teal-500" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                    <div class="flex gap-2">
                        <img class="inline-block h-16 w-16 rounded-full border-2 border-purple-400" src="{{ asset('/images/users/avatar-1.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full border-2 border-purple-400" src="{{ asset('/images/users/avatar-2.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full border-2 border-purple-400" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-16 w-16 rounded-full border-2 border-purple-400" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-3.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-4.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-5.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-6.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-7.jpg') }}" alt="Image Description">
                        <img class="inline-block h-12 w-12 rounded-full ring-2 ring-white dark:ring-gray-800" src="{{ asset('/images/users/avatar-8.jpg') }}" alt="Image Description">
                        <div
