...
>
	...
	<div class="flex justify-between" x-show="!open" >
		...
		>
			...
			<a
				href="{{ asset('attendance_overtime_data.xlsx') }}"
				class="
			        px-4 py-2
			        rounded-md
			        text-blue-500
				...
				>
					...
					@forelse($attendanceOvertimes as $attendanceOvertime)
						<tr>
							...
							>
								<button
									wire:click="$dispatch('edit', { nik: '{{ $attendanceOvertime->nik }}'})"
									class="text-gray-500 hover:text-sky-700 text-end"
								>
									Edit
								</button>
								<button
									wire:click="$dispatch('delete', { nik: '{{ $attendanceOvertime->nik }}'})"
									class="text-gray-500 hover:text-sky-700 text-end"
								>
									Delete
								</button>
