...
>
	<div class="flex justify-between pt-2" x-show="!open" >
		...
		>
			<a
				href="{{ asset('sub_category_data.xlsx') }}"
				class="
			        px-4 py-2
			        rounded-md
			        text-blue-500
		      ...
		      class="w-6 h-6"
				>
			      ...
			      d="M3 16.5v2.25A2.25 2.25 0 005.25
			          21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12
				...
				>
					...
					@forelse($subCategories as $subCategory)
						<tr>
							...
							>
								<button
									wire:click="$dispatch('edit', { code: '{{ $subCategory->code }}'})"
