			...
			<div class="p-6">
				...
				<form wire:submit.prevent="login">
					...
					<div class="mb-4">
						...
						<input wire:model="email" id="email" class="form-input" type="email" placeholder="Enter your email" name="email">
						@error('email') <span class="text-red-300">{{ $message }}</span> @enderror
					</div>
