...
>
	...
	<div class="flex justify-between" x-show="!open" >
		...
		>
			...
			<a
				href="{{ asset('attendance_switch-off_data.xlsx') }}"
				class="
			        px-4 py-2
			        rounded-md
			        text-blue-500
			...
			>
				...
				Attendance Switch Off Template
			</a>
			...
			@enderror
			<button
				wire:click="importAttendanceSwitchOff"
				type="button"
	...
	<div x-show="open">
		<livewire:attendance-switch-off-form />
	</div>
				...
				>
					...
					@forelse($attendanceSwitchOffs as $attendanceSwitchOff)
						<tr>
							...
							>
								<button
									wire:click="$dispatch('edit', { nik: '{{ $attendanceSwitchOff->nik }}'})"
									class="text-gray-500 hover:text-sky-700 text-end"
								>
									Edit
								</button>
								<button
									wire:click="$dispatch('delete', { nik: '{{ $attendanceSwitchOff->nik }}'})"
									class="text-gray-500 hover:text-sky-700 text-end"
								>
									Delete
								</button>
