					...
					@forelse($employees as $employee)
						<tr>
							...
							<td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex flex-col" style="width: 100px">
								<button class="text-gray-500 hover:text-sky-700 text-end" wire:click="$dispatch('edit', { code: '{{ $employee->code }}'})">Edit</button>
								<button class="text-gray-500 hover:text-sky-700 text-end" wire:click="$dispatch('delete', { code: '{{ $employee->code }}'})">Delete</button>
							</td>
						</tr>
					@empty
						<tr>
