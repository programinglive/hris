...
export function ImportDialog({ isOpen, onClose, templateUrl }: ImportDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post('/organization/department/import/process', {
      forceFormData: true,
      onSuccess: (page) => {
        ...
        setImportMessage(response.flash?.message || 'Import completed successfully');
        if (response.flash?.results) {
          setImportResult(response.flash.results);
        }
      },
      onError: (errors) => {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="sm:max-w-md md:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload an Excel file to import multiple departments at once.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  First, download our Excel template and fill it with your department data.
                </p>
              </div>
          ...
          <DialogFooter className="flex justify-between sm:justify-between">
            ...
            {importStatus !== 'success' && (
              ...
              >
                {processing ? 'Importing...' : 'Import Departments'}
              </Button>
            )}
            {importStatus === 'success' && (
              <Button 
