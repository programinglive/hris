...
export default function CreateDivision() {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
      title: 'Create',
      href: '/organization/division/create',
    }
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post('/organization/division');
  };

  return (
    <AppLayout title="Create Division" breadcrumbs={breadcrumbs}>
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold">Create New Division</h1>
          <p className="text-gray-500 mt-1">Add a new division to your organization structure</p>
        </div>
