...
export default function BrandEdit() {
  ...
  const { brand, companies, branches } = props;
  ...
  const [formData, setFormData] = useState({
    ...
    company_id: brand.company_id ? brand.company_id.toString() : '',
    branch_id: brand.branch_id ? brand.branch_id.toString() : '',
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
      title: 'Edit',
      href: `/organization/brand/${brand.id}/edit`,
    }
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.post(`/organization/brand/${brand.id}`, formPayload, {
      onError: (errors) => {
        setErrors(errors);
      }
    });
  ...
  return (
    <AppLayout title="Edit Brand" breadcrumbs={breadcrumbs}>
      <div className="p-6">
