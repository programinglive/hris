...
class LeaveTypeTable extends Component
{
     ...
     * (CSV, XLSX, or XLS) and stores it in the 'attendanceLeaveTypes' directory.
     * It then uses
     ...
     */
    public function importLeaveType(): void
    {
        $this->validate([
            'import' => 'required|mimes:csv,xlsx,xls',
        ]);

        $this->import->store(path: 'attendanceLeaveTypes');
    ...
    /**
     * Handles the event when an attendanceLeaveType is created.
     *
     * @param  int  $attendanceLeaveTypeId  The ID of the created attendanceLeaveType.
     */
    #[On('attendanceLeaveType-created')]
    public function attendanceLeaveTypeAdded(int $attendanceLeaveTypeId): void
    {
        $this->showForm = false;
    }

    /**
     * Handles the event when an attendanceLeaveType is updated.
     *
     * @param  int  $attendanceLeaveTypeId  The ID of the updated attendanceLeaveType.
     */
    #[On('attendanceLeaveType-updated')]
    public function attendanceLeaveTypeUpdated(int $attendanceLeaveTypeId): void
    {
        $this->showForm = false;
    }
    ...
    /**
     * Handles the event when an attendanceLeaveType is deleted.
     */
    #[On('attendanceLeaveType-deleted')]
    public function attendanceLeaveTypeDeleted(): void
    {
        $this->showForm = false;
        $this->resetPage();
        $this->getLeaveType();
    ...
    /**
     * Shows the form attendanceLeaveType.
     */
    #[On('show-form')]
    ...
    /**
     * Hides the form attendanceLeaveType.
     */
    #[On('hide-form')]
    ...
    /**
     * Retrieves a paginated list of attendanceLeaveTypes based on a search query.
     *
     * @return LengthAwarePaginator The paginated list of attendanceLeaveTypes.
     */
    public function getLeaveType(): LengthAwarePaginator
    {
        $attendanceLeaveTypes = Attendance::where(function ($query) {
